    ...
    <div class="col-5">
        <form method="POST" action="{{ route('login') }}">
            ...
            <table>
                ...
                <tr>
                    <th>メールアドレス</th>
                    <td><input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="qiitahuu@qiitahuu.com" size="50" name="email" required></td>
                    @if ($errors->has('email'))
                ...
                <tr>
                    <th>パスワード</th>
                    <td><input type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required size="50"></td>
